...
class TargetWidget(QWidget):
  ...
  def __init__(self, config: ObservableCollection) -> None:
    ...
    fixed_form = Form.build(config, ['Name:', 'Value:'],
      ...
      Form.Choice('Task group', 'task_group', task_groups), 
    ...
    random_form = Form.build(config, ['Name:', 'Min:', 'Max:'],
      ...
      Form.Constant('Task group', 'task_group', random.choice(task_groups)),
    )
...
async def run(context: TaskContextProtocol) -> TaskResult: #pylint: disable=too-many-statements
  ...
  if converter is None:    
    ...
    def on_change(source, action, key, value):
      ...
      if key == 'Running' and value: # do smthg when STORAGE gets switched on
        ...
        context.trial_summary_data.used_values['code_name_and_version'] = ["gaussian_delayed_saccade_task_code_v1.0"]
  ...
  # print("xxxxxxxxxxxxxxxxxxxxxxxxxtask_groupxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
  # print("xxxxxxxxxxxxxxxxxxxxxxxxxtask_groupxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
  # print(config['task_group'])
  # print("xxxxxxxxxxxxxxxxxxxxxxxxxtask_groupxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
  # print("xxxxxxxxxxxxxxxxxxxxxxxxxtask_groupxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx") 
